...
| **Daemon** | The persistent runtime substrate that owns everything above: agent runtimes, attribution recording, the workflow engine, and schedule firing. It outlives the app — which is why agents survive app restarts and schedules fire unattended. |
